...
public class ChildStatuses {

	@JsonProperty("dashboardStatus")
	private List<Dashboardstatus> dashboardStatus = null;
	@JsonIgnore
	...
	@JsonProperty("dashboardStatus")
	public void setDashboardStatus(List<Dashboardstatus> dashboardStatus) {
	...
	public String toString() {
		...
		sb.append(ChildStatuses.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
				.append('[');
